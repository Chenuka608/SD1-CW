...
while True:
    try:
        ...
        with open('progression.txt', 'w' ) as sf:
            for i in range (0,len(progress_list),3):
                ...
                sf.write("Progress -"+ progress_str + "\n")
            ...
            for i in range (0,len(moduleT),3):
                ...
                sf.write("Progress (module trailer) - " + moduleT_str + "\n")
            ...
            for i in range (0,len(moduleR),3):
                ...
                sf.write("module retriever - " + moduleR_str +"\n")
            ...
            for i in range (0,len(excludeL),3):
                ...
                sf.write("Exclude - " +excludeL_str + "\n")

            print("-"*60,"\nPart3\n")
        with open('progression.txt','r') as rf:
            data = rf.read()
            print(data)
            break
